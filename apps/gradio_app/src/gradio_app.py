...
with gr.Blocks(title="YOLOv11n Object Detection", theme=gr.themes.Default()) as demo:
    with gr.Row():
        ...
        with gr.Column(scale=1):
            ...
            detect_btn = gr.Button("Detect Doors", variant="primary")
        ...
        with gr.Column(scale=1):
            ...
            json_output = gr.JSON(
                label="Bounding Boxes and Classifications", height=200
            )

    # Connect the button to the processing function
    detect_btn.click(
        fn=inference, inputs=[input_image], outputs=[output_image, json_output]
    )
